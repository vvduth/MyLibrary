...
public class favoriteBooksActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = findViewById(R.id.favorRecView);
        ...
        adapter.setBooks(Utils.getFavouriteBooks()); //can use getAlreadyReadBooks directly
        //In naim activity put Utils.getInstance to avoid Null pointer exception when user click direct
    }
