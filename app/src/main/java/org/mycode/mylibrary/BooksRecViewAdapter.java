                ...
                holder.btnDelete.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                           /* if(Utils.getInstance().removeFromAlreadyReadBook(books.get(position))){
                                ...
                                notifyDataSetChanged(); //removed the book imidiately when press
                            } else {
                                Toast.makeText(mContext, books.get(position).getName() + "can not be removed, something went wrong", Toast.LENGTH_SHORT).show();
                            }*/
                ...
                holder.btnDelete.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                if(Utils.getInstance().removeFromWhistList(books.get(position))){
                                    Toast.makeText(mContext,   "Book removed", Toast.LENGTH_SHORT).show();
                                    notifyDataSetChanged(); //removed the book imidiately when press
                                }
                            }
                ...
                holder.btnDelete.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                if(Utils.getInstance().removeFromCurrentRead(books.get(position))){
                                    Toast.makeText(mContext,   "Book removed", Toast.LENGTH_SHORT).show();
                                    notifyDataSetChanged(); //removed the book imidiately when press
                                }
                            }
